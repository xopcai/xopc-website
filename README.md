...
xopc is a local-first AI assistant for long-running goals: it remembers context, moves the next step, and runs across CLI, desktop, web, mobile, and messengers.
