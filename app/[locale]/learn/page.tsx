...
export async function generateMetadata({ params }: Pick<Props, "params">): Promise<Metadata> {
  ...
  return { title: locale === "zh" ? "按场景学习" : "Learn by doing", description: locale === "zh" ? "六个桌面实战工作流程，配套中文视频、图文步骤和可下载练习材料。" : "Six desktop workflows with Chinese video tutorials, illustrated steps and downloadable practice files.", alternates: { canonical: `/${locale}/learn`, languages: Object.fromEntries(locales.map(lang => [lang, `/${lang}/learn`])) } };
}
